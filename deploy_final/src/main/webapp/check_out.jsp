...
<body>
	<div class="my-modal-orders"
		style="display:${requestScope.orders_msg eq null?"none":""}">
		<div class="success-orders">
			...
			<div class="success-orders-back"
				onclick="window.location.href='product'">Quay về trang mua
				hàng</div>
		</div>
	</div>
			...
			<div class="checkout-info-user">
				...
				<ul class="checkout-ul">
					...
					<li><input
						...
						type="text" placeholder="Email" name="recepient">
						<p style="color: red">${recepientnull }</p></li>
				...
				<div class="wrap-checkout">
					...
					<div class="confirm-checkout">Hoàn tất đơn hàng</div>
				</div>
			</div>
				...
				<c:forEach var="i" items="${sessionScope.list_orders }">
					<div class="checkout-item">
						<span class="quantity-summary">${i.quantity}</span> <img
							...
							src="data:image/jpg;base64,${i.product.image}">
		...
		document
				...
				.addEventListener(
						...
						function() {
							...
							let inp = document
									.querySelector('input[name="recepient"]').value;
