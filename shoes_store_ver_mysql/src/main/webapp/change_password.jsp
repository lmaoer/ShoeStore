	...
	<div class="main">
		...
		<div class="subnav">
			<p>
				<a href="index.jsp">Trang chủ</a> <i
					class="fas fa-angle-double-right"></i> Đổi mật khẩu
			</p>
		</div>
		...
		<div class="info-user">
			...
			<form action="user" method="post">
				...
				<div>
					<label>Mật khẩu cũ </label> <input required type="password"
							placeholder="Mật khẩu cũ" name="old"></input>
				</div>
				<div>
					<label>Mật khẩu mới</label> <input required type="password"
						placeholder="Mật khẩu mới" name="new"></input>
				</div>
				<div>
					<label>Xác nhận mật khẩu</label> <input required type="password"
						name="new2"></input>
				</div>
