				...
				<div class="product-grid">
					...
					<c:forEach var="item" items="${products_list}">
						<div class="product-item"
							...
							<img class="product-img" src="data:image/jpg;base64,${item.image}"
								alt="product_image">
	...
	fetch("/shoes_store_final/brand")
		...
		.then((data) => {
			...
			for (b of list) {
				...
				html = '<p style="color:\${'+b['id']+'==brand?"orangered":""}"><i class="fas fa-shoe-prints"></i> <a href="product?key=${key}&costlv=${costlv}&brand='+b['id']+'&sort=${sort}">'+b['name']+'</a>';
				document
					.querySelector(".search-brand")
					.insertAdjacentHTML("beforeend", html);
			}
		});
	</script>
